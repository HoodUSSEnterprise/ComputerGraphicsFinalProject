...
inline ShopItemDef getShopItemDef(ShopItem item)
{
    switch (item)
    {
    case ShopItem::StartGoldBonus: return {"Shop_StartGold",   80,  40};
    case ShopItem::TowerDiscount:  return {"Shop_Discount",    100, 50};
    case ShopItem::DamageBoost:    return {"Shop_Damage",      120, 60};
    case ShopItem::RangeBoost:     return {"Shop_Range",       100, 50};
    case ShopItem::LivesBonus:     return {"Shop_Lives",       90,  45};
    case ShopItem::FireRateBoost:  return {"Shop_FireRate",    110, 55};
    default: return {"", 0, 0};
    }
}
